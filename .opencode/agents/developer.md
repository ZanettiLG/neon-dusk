...
7. Self-review (56 checks)
8. Handoff do código implementado

## Self-Review (56 checks)
...
- [ ] Claims de docs (README, comentários de handoff) descrevem o comportamento REAL implementado — não o comportamento desejado. Verificar cada claim contra o código antes de encerrar.
