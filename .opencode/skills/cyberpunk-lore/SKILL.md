---
name: cyberpunk-lore
description: Cyberpunk universe reference for UI and narrative writing. Provides vocabulary, tone of voice, and references for writing copy, UI text, and diegetic descriptions. Use when writing UI text, item descriptions, implant flavor, district descriptions, or despachante dialogue.
license: MIT
...
- Gerando diálogos de despachantes
...
Vocabulário da São Paulo periférica que sobreviveu até 2087. Uso obrigatório em falas de despachante, NPCs de rua e descrições ambientais da Quebrada e do Fervo.
...
Nomes oficiais do jogo. Uso obrigatório em todo texto de produto — copy, UI, lore. Termos banidos e regras completas em `docs/definicoes-de-produto/06-terminologia-e-ip.md`.
...
| **Braço de Ferro** | Braço hidráulico de força | "Braço de Ferro é Ogum abençoando a porta. A porta que cai." |
| **Óptica Vidraça** | Olho cibernético feito do vidro da Paraíso | "Olho de vidro enxerga através do concreto." |
...
| **Estradeiro** | Banca da estrada — Ogum rege o asfalto | "Estradeiro não tem casa. Tem rota." |
| **Socorrista** | Banca da cura — o socorro da rua | "O Socorrista chega quando o Resgate não chega." |
...
| **Dogão** | Cachorro-quente completo (purê, batata palha, milho, ervilha, catupiry) | 24h. Combustível de corredor e motoboy. "Dogão do seu Zé: 30 anos no mesmo ponto, sobreviveu a 3 desastres corporativos" |
...
Toda interação de rua segue este padrão de três batidas. Use em diálogos de despachante, NPCs da Quebrada e saudações de bar.
