---
description: Generate narrative content for Neon Dusk. Produces district descriptions, stim flavor text, despachante dialogue, and other diegetic text following the cyberpunk tone.
agent: build
subtask: false
---
